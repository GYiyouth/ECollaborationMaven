...
function paging(domBox,addclass,domList,each,pagePreDom,pageNextDom,arrJson)
{
    ...
    for (var i = 0; i < each; i++) {
        ...
        var domP = '<a name="team" href="student-team-info.html" class="list-group-item" title='+arrJson[i].id+'>';
...
// 判断当前元素索引
    ...
    function changeHtml(domBox, currentNum) {
        ...
        for (var i = 0; i < each; i++) {
            ...
            var domP = '<a name="team" href="student-team-info.html" class="list-group-item" title='+arrJsonCurrent.id+'>';
